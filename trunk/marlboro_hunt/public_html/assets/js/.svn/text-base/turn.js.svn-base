...
(function($){
  $.fn.fold = function(options) {
    ...
    */
    ...
    if (options.side == 'right' && !options.turnImage) defaults.turnImage = 'images/fold-sw.png';
