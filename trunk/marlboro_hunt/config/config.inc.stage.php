...
$CONFIG['BASE_DOMAIN_PATH'] = "http://{$_SERVER['HTTP_HOST']}/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "/home/webuser/www/marlboro.ph-phase02/public_html/public_assets/";
...
if($local){
	...
	$CONFIG['DATABASE'][0]['USERNAME'] 	= "marlborostage";
	$CONFIG['DATABASE'][0]['PASSWORD'] 	= "ZiSx6hwiIhOY3MGzq4yqiRqOS4EhtY";
	$CONFIG['DATABASE'][0]['DATABASE'] 	= "marlborostage";
