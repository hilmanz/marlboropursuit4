...
if(preg_match("/202./i",gethostbyname($_SERVER['HTTP_HOST']))){
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/marlboro_hunt_2013/trunk/athreesix/";
}else{
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/marlboro_hunt_2013/trunk/athreesix/";
}
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "D:/xampp/htdocs/marlboro_hunt_2013/trunk/marlboro_hunt/public_html/public_assets/";
...
if($local){
	...
	$CONFIG['DATABASE'][0]['DATABASE'] 	= "marlboro_pursuit_2013";
