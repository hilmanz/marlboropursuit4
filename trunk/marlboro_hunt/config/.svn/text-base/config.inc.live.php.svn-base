...
$CONFIG['BASE_DOMAIN_PATH'] = "https://{$_SERVER['HTTP_HOST']}/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "/home/webuser/www/marlboro.ph-phase02/web/public_assets/";

if($CONFIG['LOCAL_DEVELOPMENT']) $CONFIG['LOGIN_PAGE']  = "{$DOMAIN}{$PUBLIC_HTML}login";
else  $CONFIG['LOGIN_PAGE']  = "{$DOMAIN}{$PUBLIC_HTML}login"; 
...
/* set automatic logout after n second idle */
...
if($local){
	$CONFIG['DATABASE'][0]['HOST'] 		= "10.66.16.202";
	$CONFIG['DATABASE'][0]['USERNAME'] 	= "marlboro.ph2";
	$CONFIG['DATABASE'][0]['PASSWORD'] 	= "NDexb4t5235mLqn2crk3Oqw19ZIf85";
	$CONFIG['DATABASE'][0]['DATABASE'] 	= "marlboro.ph2";
}else{
        $CONFIG['DATABASE'][0]['HOST']          = "10.66.16.202";
        $CONFIG['DATABASE'][0]['USERNAME']      = "marlboro.ph2";
        $CONFIG['DATABASE'][0]['PASSWORD']      = "NDexb4t5235mLqn2crk3Oqw19ZIf85";
 ...
 * Email settings
 */
$CONFIG['EMAIL_FROM_DEFAULT'] = "noreply-pursuit@marlboro.com";
