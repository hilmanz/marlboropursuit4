...
class article_calendar_list{
	...
	function main(){
		...
		$articlelist = $this->apps->contentHelper->getArticleContent(null,10,0,array($topcontent));
		...
		return $this->apps->View->toString(TEMPLATE_DOMAIN_WEB ."widgets/article-calendar-list.html");
	}
}
?>